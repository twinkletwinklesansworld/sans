                    ...
                    <Grid item xs={12} md={6}>
                        <Card>
                            <CardContent>
                                ...
                                <Grid item>
                                    <TextField color="secondary" value={this.state.id} required onChange={e => this.setState({id: e.target.value})} label="아이디 또는 이메일을 입력해 주세요" type="email" fullWidth style={{marginBottom: 10}}/>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} md={6}>
                                            <Button variant="contained" color="primary" onClick={async () => {
                                                this.props.enqueueSnackbar('[반반샌월] 잠시만 기다려 주세요', {
                                                    variant: 'info'
                                                })
                                                ...
                                                if (data.token) {
                                                    this.props.enqueueSnackbar('[반반샌월] 로그인이 정상적으로 되었습니다', {
                                                        variant: 'success'
                                                    })
